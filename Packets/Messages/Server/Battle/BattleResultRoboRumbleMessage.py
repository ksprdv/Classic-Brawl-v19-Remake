...
class BattleResultRoboRumbleMessage(Writer):
    ...
    def encode(self):
        ...
        self.writeVint(3) # Battle End Game Mode (2 = Showdown, 3 = Robo Rumble, 4 = Big Game, 5 = Duo Showdown, 6 = Boss Fight. Else is 3vs3)
