...
class BattleResultBigGameMessage(Writer):
    ...
    def encode(self):
        ...
        self.player.trophiesAnim = totaltokens
        self.player.trophiesAnim = trophies
        self.player.bigTokensAnim = 1

        self.writeVint(4) # Battle End Game Mode (2 = Showdown, 3 = Robo Rumble, 4 = Big Game, 5 = Duo Showdown, 6 = Boss Fight. Else is 3vs3)
