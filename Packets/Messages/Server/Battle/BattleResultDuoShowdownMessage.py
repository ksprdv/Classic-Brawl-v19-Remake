...
class BattleResultDuoShowdownMessage(Writer):
    ...
    def encode(self):
        ...
        DataBase.replaceValue(self, 'availableTokens', 200)
        self.player.tokensAnim = totaltokens
        self.player.trophiesAnim = trophies
        self.player.bigTokensAnim = 1

        self.writeVint(5) # Battle End Game Mode (2 = Showdown, 3 = Robo Rumble, 4 = Big Game, 5 = Duo Showdown, 6 = Boss Fight. Else is 3vs3)
        ...
        if self.player.team == 0:
            ...
            if self.player.bot6_team == 0:
                ...
                self.writeVint(0) # Team and Star Player Type
        self.writeScId(16, self.player.bot6) # Bot 1 Brawler
        self.writeVint(0) # Bot 1 Skin
        self.writeVint(0) # Brawler Trophies
        self.writeVint(10) # Brawler Power Level
        self.writeBoolean(False) # Player HighID and LowID Array
        #self.writeInt(self.player.high_id) # HighID
        #self.writeInt(self.player.low_id) # LowID
        self.writeString(self.player.bot6_n) # Bot 1 Name
        self.writeVint(0) # Player Experience Level
        self.writeVint(28000000) # Player Profile Icon
        self.writeVint(43000000) # Player Name Color
        ...
        if self.player.team == 0:
            ...
            if self.player.bot7_team == 0:
                ...
                self.writeVint(0) # Team and Star Player Type
        self.writeScId(16, self.player.bot7) # Bot 1 Brawler
        self.writeVint(0) # Bot 1 Skin
        self.writeVint(0) # Brawler Trophies
        self.writeVint(10) # Brawler Power Level
        self.writeBoolean(False) # Player HighID and LowID Array
        #self.writeInt(self.player.high_id) # HighID
        #self.writeInt(self.player.low_id) # LowID
        self.writeString(self.player.bot7_n) # Bot 1 Name
        self.writeVint(0) # Player Experience Level
        self.writeVint(28000000) # Player Profile Icon
        self.writeVint(43000000) # Player Name Color
        ...
        if self.player.team == 0:
            ...
            if self.player.bot8_team == 0:
                ...
                self.writeVint(0) # Team and Star Player Type
        self.writeScId(16, self.player.bot8) # Bot 1 Brawler
        self.writeVint(0) # Bot 1 Skin
        self.writeVint(0) # Brawler Trophies
        self.writeVint(10) # Brawler Power Level
        self.writeBoolean(False) # Player HighID and LowID Array
        #self.writeInt(self.player.high_id) # HighID
        #self.writeInt(self.player.low_id) # LowID
        self.writeString(self.player.bot8_n) # Bot 1 Name
        self.writeVint(0) # Player Experience Level
        self.writeVint(28000000) # Player Profile Icon
        self.writeVint(43000000) # Player Name Color
        ...
        if self.player.team == 0:
            ...
            if self.player.bot9_team == 0:
                ...
                self.writeVint(0) # Team and Star Player Type
        self.writeScId(16, self.player.bot9) # Bot 1 Brawler
        self.writeVint(0) # Bot 1 Skin
        self.writeVint(0) # Brawler Trophies
        self.writeVint(10) # Brawler Power Level
        self.writeBoolean(False) # Player HighID and LowID Array
        #self.writeInt(self.player.high_id) # HighID
        #self.writeInt(self.player.low_id) # LowID
        self.writeString(self.player.bot9_n) # Bot 1 Name
        self.writeVint(0) # Player Experience Level
        self.writeVint(28000000) # Player Profile Icon
        self.writeVint(43000000) # Player Name Color
